...
{
    public partial class ucCircles : System.Web.UI.UserControl
    {
        ...
        protected void repCircles_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            try
            {
                ...
                LinkButton lkfriendscount = (LinkButton)e.Item.FindControl("lkfriends");
                LinkButton lkmissioncount = (LinkButton)e.Item.FindControl("lkmissions");
                ...
                {
                    dynamic1 = (HtmlGenericControl)e.Item.FindControl("dvimagecircle");
