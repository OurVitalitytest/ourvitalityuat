<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PendingFriendRequests.aspx.cs" Inherits="ALEREIMPACT.User.PendingFriendRequests" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register TagPrefix="UserCt" TagName="Form" Src="~/User/ucPendingFriendRequests.ascx" %>
        ...
        window.onbeforeunload = function() {
            $(document).ready(function() {
                $.ajax({
                    ...
                    url: "PendingFriendRequests.aspx/ProcessIT",
                    data: "{}",
                    dataType: "json",
...
<body>
    ...
    <div class="center_section_mission">
        ...
        <UserCt:Form ID="frmPendingRequests" runat="server" />
    </div>
    </form>
</body>
</html>