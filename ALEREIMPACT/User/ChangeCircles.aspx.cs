...
{
    public partial class ChangeCircles : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    GetCircleImage();
                    getProfileImage();
                    divleft_sectionAbout.Attributes.Add("class", "SelectedTab");
                    DIVEditCirclesss.Style.Value = "display:none;";
                    divInvite.Style.Value = "display:none;";
                    //divInvite.Style.Add("display", "none");
                    //DVcircles.Style.Add("display", "none");
                    //DIVEditCirclesss.Visible = false;
        ...
        protected void btnInvite_Click(object sender, EventArgs e)
        {
          ...
          //  btnInvite.Attributes.Add("class", "submit_invite_sending");
            ...
            try
            {
                ...
                txtEmail.Text = "";
                txtmessage.Text = "";
                btnInvite.Attributes.Add("Class", "submit_invite");
        ...
        protected void lnkAbout_Click(object sender, EventArgs e)
        {
            ...
            divright_section.Style.Value = "display:block;";
            DIVEditCirclesss.Style.Value = "display:none;";
            divInvite.Style.Value = "display:none;";

            divleft_sectionAbout.Attributes.Add("class", "SelectedTab");
            divleft_sectionInvite.Attributes.Add("class", "about_circle");
            divEditCircle.Attributes.Add("class", "about_circle");
        ...
        protected void lnkInvite_Click(object sender, EventArgs e)
        {
            ...
            divInvite.Style.Value = "display:block;";
            DIVEditCirclesss.Style.Value = "display:none;";
            divright_section.Style.Value = "display:none;";

            divleft_sectionInvite.Attributes.Add("class", "SelectedTab");
            divleft_sectionAbout.Attributes.Add("class", "about_circle");
            divEditCircle.Attributes.Add("class", "about_circle");

        }
        protected void lnkEditCircle_Click(object sender, EventArgs e)
        {
            DIVEditCirclesss.Style.Value = "display:block;";
            divInvite.Style.Value = "display:none;";
            divright_section.Style.Value = "display:none;";

            divEditCircle.Attributes.Add("class", "SelectedTab");
            divleft_sectionAbout.Attributes.Add("class", "about_circle");
            divleft_sectionInvite.Attributes.Add("class", "about_circle");
        }
        ...
        protected void CheckBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            objAdminBAO.ProcedureType = "UCI";
            dt = AdminDAO.GetUserDeatilsCount(objAdminBAO);
            if (dt.Rows.Count > 0)
            {
                string profileimagefile = dt.Rows[0]["user_image"].ToString();
                string circleimagefile = dt.Rows[0]["circle_image"].ToString();
                objusercircles.circle_color = dt.Rows[0]["circle_color"].ToString();
                objusercircles.circle_name = profileimagefile;
                objusercircles.circle_image = circleimagefile;
                objusercircles.fk_circle_permission_id = 1;
                objusercircles.fk_circle_id = 1;
