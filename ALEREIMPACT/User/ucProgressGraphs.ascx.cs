...
{
    public partial class ucProgressGraphs : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    {
                        dvShowMultipleCalendars.Visible = true;
                        //btnSelection_Click("btnSelection", e);
                        txtDefaultWeekelyCalendar.Style.Value = "display:none";
                        //a// dvShowMultipleCalendars.Style.Value = "display:none";
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    if (!String.IsNullOrEmpty(Convert.ToString(ds.Tables[0].Rows[0]["StartDate"].ToString())) && !String.IsNullOrEmpty(Convert.ToString(ds.Tables[0].Rows[0]["StartDate"].ToString())))
                    {
                        ...
                        txtDateFrom.Text = ds.Tables[0].Rows[0]["StartDate"].ToString();
                        txtDateTo.Text = ds.Tables[0].Rows[0]["EndDate"].ToString();
                    ...
                    if (ds.Tables[3] != null)
                    {
                        if (ds.Tables[3].Rows.Count > 0)
                        {
                            ...
                            if (!String.IsNullOrEmpty(Convert.ToString(ds.Tables[3].Rows[0]["weight_left"])) && Convert.ToString(ds.Tables[3].Rows[0]["weight_left"]) != "0" && Convert.ToString(ds.Tables[3].Rows[0]["weight_left"]) != "0.00")
                            {
                                ...
                                imgEmptyChartForWeights.Visible = false;
                                lnchweigth.Visible = true;
                                if (Convert.ToInt32(lnchweigth.ChartWidth) < 1)
                                {
                                    imgEmptyChartForWeights.Visible = true;
                                    lnchweigth.Visible = false;
                                }
        ...
        protected void btnSelection_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (btnSenderId.ID == "" || btnSenderId.ID == null)
                {
                    btnSenderId.ID = "btnAll";
                ...
                if (btnSenderId.ID == "btnAll")
                {
                    ...
                    libtnAll.Style.Value = "background: none repeat scroll 0 0 #646464;color: #FFFFFF !important;";
                    libtnAll.Attributes.Add("class", "sel_graph");

                    libtnWeek.Style.Value = "background: none repeat scroll 0 0 #EDEDED;color: #FFFFFF !important;";
                    libtnWeek.Attributes.Remove("class");

                    libtnToday.Style.Value = "background: none repeat scroll 0 0 #EDEDED;color: #FFFFFF !important;";
                    libtnToday.Attributes.Remove("class");

                    libtnMonth.Style.Value = "background: none repeat scroll 0 0 #EDEDED;color: #FFFFFF !important;";
                    libtnMonth.Attributes.Remove("class");

                    libtnYear.Style.Value = "background: none repeat scroll 0 0 #EDEDED;color: #FFFFFF !important;";
                    libtnYear.Attributes.Remove("class");
                ...
                else
                {
                    ...
                    {
                        libtnToday.Style.Value = "background: none repeat scroll 0 0 #646464;color: #FFFFFF !important;";
                        libtnToday.Attributes.Add("class", "sel_graph");


                        libtnWeek.Style.Value = "background: none repeat scroll 0 0 #EDEDED;color: #FFFFFF !important;";
                        libtnWeek.Attributes.Remove("class");

                        libtnAll.Style.Value = "background: none repeat scroll 0 0 #EDEDED;color: #FFFFFF !important;";
                        libtnAll.Attributes.Remove("class");
                    ...
                    {
                        //btnMonth.Style.Value=
                        //btnAll.Style.Value =
                        //btnToday.Style.Value=
                        //btnYear.Style.Value =                        
                        libtnWeek.Style.Value = "background: none repeat scroll 0 0 #646464;color: #FFFFFF !important;";
                        libtnWeek.Attributes.Add("class", "sel_graph");
                    ...
                    else if (btnSenderId.ID == "btnMonth")
                    {
                        ...
                        libtnMonth.Style.Value = "background: none repeat scroll 0 0 #646464;color: #FFFFFF !important;";
                        libtnMonth.Attributes.Add("class", "sel_graph");
                    ...
                    else if (btnSenderId.ID == "btnYear")
                    {
                        ...
                        libtnYear.Style.Value = "background: none repeat scroll 0 0 #646464;color: #FFFFFF !important;";
                        libtnYear.Attributes.Add("class", "sel_graph");
