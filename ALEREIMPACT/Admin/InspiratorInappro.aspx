<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="InspiratorInappro.aspx.cs" Inherits="ALEREIMPACT.Admin.InspiratorInappro" Title="Inspirator Inappropriate" %>
   ...
   <table width="695" border="0" cellspacing="0" cellpadding="0" style="background:none;" class="table_bg">
      ...
      <td>
       <div id="breadcrumb">
            ...
            <span style="color:#50514F;">Inspirator Inappropriate &nbsp;(<asp:Label ID="lbname" runat="server" Text=""></asp:Label>
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="102%">
                    ...
                    <td>
                       ...
                       <asp:TemplateField HeaderText="Date" HeaderStyle-ForeColor="#000">
                            <ItemTemplate>
                                <asp:Label ID="lbdate" runat="server" Text='<%#Eval("InspiratorInappro_on") %>'></asp:Label>
                            </ItemTemplate>
                            </asp:TemplateField>
