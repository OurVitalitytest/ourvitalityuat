<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="FeedBackMessage.aspx.cs" Inherits="ALEREIMPACT.Admin.FeedBackMessage" Title="FeedBack Messages" %>
     ...
     <div id="main_grid">
      ...
      <td>
       <div id="breadcrumb" style="width: 955px !important;">
            ...
            <asp:LinkButton ID="lnkMsg" runat="server" onclick="lnkMsg_Click" style="color: #45B5B0 !important;">Feedback 
            And Tickets</asp:LinkButton>
            <img src="../images/arow.jpg" width="13" height="12" alt="" border="0" />
            <span style="color:#50514F;">
           <asp:Label  ID="lbname" runat="server" Text="FeedBack Messages"></asp:Label>
            </span>
        </div>
      </td>
      </tr>
      ...
      <div style="float:left; height: 500px;    overflow: scroll; margin-left:5px;">
                                ...
                                <asp:TemplateField>
                                <ItemTemplate> 
                                <asp:LinkButton ID="LinkButton1" runat="server"  CommandName="lnkMessage" CommandArgument='<%#Eval("FB_ID") %>' 
                                        style="float:left; height: 35px; color: #151515;">
                                    <asp:Label ID="Label1" runat="server" Text='<%#Eval("FB_ID") %>' Visible="false"></asp:Label>
                                     <asp:Label ID="Label2" runat="server" Text='<%#Eval("name") %>' style="font-size: 17px; text-transform:capitalize;" ></asp:Label>
                                     <br />
                                     
                                      <asp:Label ID="Label3" runat="server" Text='<%#Eval("FB_MESSAGE") %>'></asp:Label>
                                    &nbsp;
                                       <asp:Label ID="Label4" runat="server" Text='<%#Eval("FB_DATE") %>'></asp:Label>
                                       </asp:LinkButton>
                                </ItemTemplate>
                                </asp:TemplateField>
                                </Columns>
          ...
          <div style="float:left; ">
                            ...
                            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" 
                                ...
                                <ItemTemplate>
                                 ...
                                 <asp:Label ID="Label1" runat="server" Text='<%#Eval("FB_ID") %>' Visible="false"></asp:Label>
                                  <asp:Label ID="Label2" runat="server" Text='<%#Eval("name") %>' style="font-size: 17px; text-transform:capitalize; " ></asp:Label>
                                      &nbsp;
                                  <asp:Label ID="Label9" runat="server" Text='<%#Eval("FB_DATE") %>' style=" float: right; margin-right: 11px; " ></asp:Label>
                                    </div>
                                    <br />
                                 ...
                                 <br />
                                 <div style="float:left;  margin-left: -89px; margin-top: 28px;">
                    ...
                    FilledStarCssClass="filledRatingStar" EmptyStarCssClass="emptyRatingStar" Enabled="false" ReadOnly="true"  >
                                    </asp:Rating>
                                 </div>
                                 <br />
                                  <div style="float:left;margin-bottom: 33px; margin-left: -208px;
margin-top: 46px;">
                                    <asp:Label ID="Label7" runat="server" Text='<%#Eval("FB_MESSAGE") %>' ></asp:Label>
                        </div>
